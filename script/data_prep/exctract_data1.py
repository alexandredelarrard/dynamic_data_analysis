...
def fill_missing_rank(data):
    ...
    ### correct loser
    missing_data= pd.read_csv(r"D:\projects\tennis betting\data\brute_info\historical\correct_missing_values\missing_rank_loser.csv")
...
#
#def get_players_list(data):
#    liste_players = list(set(list(set(data["Winner"])) + list(set(data["Loser"]))))
#    pd.DataFrame(liste_players, columns = ["players"]).to_csv(r"D:\projects\tennis betting\data\players\liste_players.csv", index = False)
#    
#    print("saved")
#    
#
