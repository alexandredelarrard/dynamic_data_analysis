...
def data_prep_for_modelling(data):
    ...
    columns_to_keep = list(set(['diff_fatigue_games', 'Common_matches', 'diff_aces', 'diff_df', 'diff_1st_serv_in', 'diff_1st_serv_won', 'diff_2nd_serv_won', 
                     'diff_skill_serv', 'diff_skill_ret', 'indoor_flag',  'week', 'best_of', 'match_num', 'prize',  'diff_days_since_stop', 'diff_hand', 'diff_is_birthday',
                     ...
                     'diff_rank', 'diff_rk_pts', 'diff_home', 'target', 'masters', 'round', 'minutes']))
